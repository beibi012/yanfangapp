<template>
	<view class="takenotes_container" >
		<view :style="(big==-1)?'':'height:500px;overflow: hidden;'">
			...
			<view v-for="note in takenotes">
				...
				<view class="add_headline">
					<text>登记问题</text>
					<view class="add_button" @click="addnotes"><image class="add_img" src="/static/Addto@2x.png" mode="widthFix"></image></view>
				</view>
				<!-- form表单基础样式输入框、下拉框、显示内容、单选p116 -->
			<view class="basic_container">
